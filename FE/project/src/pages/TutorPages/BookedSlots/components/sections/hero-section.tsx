...
const StatBox = ({
  ...
  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 flex flex-col">
    <div className="flex items-center gap-2 mb-2">
      {icon}
      <span className="text-sm text-blue-100 font-medium whitespace-nowrap">{label}</span>
    </div>
    <p className="text-3xl font-bold mt-auto">{value}</p>
  </div>
);
  ...
  return (
    <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 rounded-2xl shadow-lg p-8 text-white mb-8">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div>
          <h1 className="text-4xl font-bold mb-2">Lịch đã đặt</h1>
          <p className="text-blue-100 text-lg">
            Quản lý và theo dõi các buổi học với học viên
          </p>
        </div>
